do
	...
	vim.keymap.set("n", "<A-s>", "<cmd>silent !tmux neww ~/.local/scripts/tmux-sessionizer.sh<CR>")
...
do
	...
	vim.pack.add({ { src = gh("davidmh/cspell.nvim") } })
	vim.pack.add({ { src = gh("nvimtools/none-ls.nvim") } })
